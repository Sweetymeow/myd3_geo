...
dispatch.on("load.pie", function(countryById) {
    ...
    var bkt_img = cirGroup.append("image")
                    .attr("class","bucketSvg")
                    .attr("opacity",0)
                    .attr("xlink:href","img/Bbucket.svg");
    
    var bkt_textT = cirGroup.append("text").attr("class","bktText_top")
                .style("fill", "white")
                .style("font-size", "22px");
    var bkt_textB = cirGroup.append("text").attr("class","bktText_btm")
                .style("fill", "white")
                .style("font-size", "20px");
    
	var pppCircle = cirGroup.append("circle").attr("class","ppp");
    ...
    var equalCircle_bg = cirGroup.append("rect")
                        .attr("fill","transparent")
                        .attr("width", 66).attr("height", 30);
    
    var equalCircle_text = cirGroup.append("text").attr("class","equalText")
            .style("fill", "#FF4081").style("font-size", "15px");
  ...
  dispatch.on("statechange.pie", function(d) {
      ...
      equalCircle.attr("cx",0).attr("cy",0).attr("r", 1.5*radius)
                .attr("stroke", "#FF4081")
	  			.attr("stroke-width", "2")
	  			.style("fill", "#FFC107");
      
      if(cyPPP>70){
          equalCircle_bg.style("fill", "rgb(255, 193, 7)")
              .attr("transform", "translate(-28,"+(-1.5*radius-10)+")");
      
          equalCircle_text.text('Equality')
              .attr("transform", "translate(-20,"+(-1.5*radius+10)+")");
      }
